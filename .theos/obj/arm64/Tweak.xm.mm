...
@class SBIconController; @class NSObject; @class NCNotificationListSectionRevealHintView; @class SBIconListPageControl; @class SBFloatingDockPlatterView; @class UIStatusBarForegroundView; @class MTStaticColorPillView; @class SBUICallToActionLabel; @class SBDockView; @class SBDashBoardQuickActionsButton; @class SBIconZoomAnimator; @class SBDashBoardTeachableMomentsContainerView; @class SBIconView; @class SBFLockScreenDateSubtitleDateView; @class SBCoverSheetIconFlyInAnimator; @class UIStatusBar_Modern; @class SBDashBoardPageControl; 
