...
@class SBIconView; @class SBDockView; @class SBFloatingDockPlatterView; @class SBIconListPageControl; @class SBHomeScreenTodayViewController; @class UIStatusBarForegroundView; @class SBDashBoardTodayPageViewController; @class MTStaticColorPillView; @class UIStatusBar_Modern; @class SBDashBoardQuickActionsButton; @class SBIconZoomAnimator; @class SBDashBoardPageControl; @class SBRootFolderView; @class SBFLockScreenDateSubtitleDateView; @class SBIconController; @class NCNotificationListSectionRevealHintView; @class SBDashBoardTeachableMomentsContainerView; @class SBUICallToActionLabel; @class NSObject; @class SBCoverSheetIconFlyInAnimator; @class SBPagedScrollView; 
